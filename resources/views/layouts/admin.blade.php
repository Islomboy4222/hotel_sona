...
<head>
  ...
  <title>{{env('APP_NAME', 'Admin')}} - Admin qismi</title>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Messages -->
                <span class="badge badge-danger badge-counter">{{count($new_message)}}</span>
              </a>
              <!-- Dropdown - Messages -->
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                @foreach($new_message as $post)
                  <a class="dropdown-item d-flex align-items-center" href="{{route('admin.feedbacks.show', $post->id)}}">
                    <div class="dropdown-list-image mr-3">
                      <img class="rounded-circle" src="https://source.unsplash.com/fn_BT9fwg_E/60x60" alt="">
                      <div class="status-indicator bg-success"></div>
                    </div>
                    <div class="font-weight-bold">
                      <div class="text-truncate">{{$post->name}}</div>
                      <div class="small text-gray-500">{{$post->created_at->format('H:i, d.m.y')}}</div>
                    </div>
                  </a>
                @endforeach
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="{{ asset('dashboard/img/admin.jpg') }}">
              </a>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Boshqaruvdan chiqishni hoxlaysizmi?</div>
